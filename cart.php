...
if(isset($_GET['delete_all'])){
   mysqli_query($con, "DELETE FROM `cart` WHERE User Id = '$user_id'") or die('query failed');
   header('location:cart.php');
}
...
<section class="shopping-cart">
   ...
   <div class="box-container">
      <?php
         $grand_total = 0;
         $select_cart = mysqli_query($con, "SELECT * FROM `cart` WHERE User Id=$user_id") or die('query failed');
